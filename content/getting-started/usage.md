...
Once you have [installed Selenium Compose][install], make sure it is in your `PATH`. You can test that Selenium Compose has been installed correctly via the `help` command:
